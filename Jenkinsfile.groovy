                ...
                stage('streaming') {
                    stages {
                        ...
                        stage('build streaming') {
                            steps {
                                git branch: params.BRANCH, url: 'https://github.com/jenkins-examples-1/streaming.git'
                        ...
                        stage('deploy streaming') {
                            steps {
                                ...
                                sh """cd target
                                      ...
                                      curl -i -X PUT  --upload-file streaming-1.0-SNAPSHOT.jar "http://datanode:9864/webhdfs/v1/streaming_${params.BRANCH}/common-libs-${project_version}.jar?op=CREATE&namenoderpcaddress=namenode:9000&createflag=&createparent=true&overwrite=true"
                                   """
                            }
                        }
                    }
                ...
                stage('batch') {
                    stages {
                        ...
                        stage('build batching') {
                            steps {
                                git branch: params.BRANCH, url:  'https://github.com/jenkins-examples-1/batching.git'
                        ...
                        stage('deploy batching') {
                            steps {
                                sh """cd target
                                  ...
                                  curl -i -X PUT --upload-file batching-1.0-SNAPSHOT.jar "http://datanode:9864/webhdfs/v1/batch_${params.BRANCH}/batching-1.0-SNAPSHOT.jar?op=CREATE&namenoderpcaddress=namenode:9000&createflag=&createparent=true&overwrite=true"
                                   """
                            }
                        }
